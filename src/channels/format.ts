// Formatting helpers shared between channel adapters and outbound tools.
// markdownToTelegramHtml and formatOutboundChannelMessage were previously
// in src/tools/impl/MessageChannel.ts.
