...
describe("extractAssistantText", () => {
  test("returns null for non-assistant_message types", () => {
    expect(
      extractAssistantText({ message_type: "tool_call_message" }),
    ).toBeNull();
    expect(
      extractAssistantText({ message_type: "reasoning_message" }),
    ).toBeNull();
    expect(
      extractAssistantText({ message_type: "tool_return_message" }),
    ).toBeNull();
  });
